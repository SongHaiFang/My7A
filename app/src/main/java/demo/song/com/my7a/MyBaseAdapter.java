...
public class MyBaseAdapter extends BaseAdapter {
    ...
    private List<MyBean.ApkBean> mlist;

    public MyBaseAdapter(Context context, List<MyBean.ApkBean> mlist) {
...
//            holder.tv_2= (TextView) view.findViewById(R.id.text_categroy);
        ...
        holder.tv_1.setText(mlist.get(i).name);
        setImage(mlist.get(i).iconUrl,context,holder.iv_1);
